...
# This script using clip spectrogram as a model input for fine-tune VGGish #
       ...
       with tf.Session() as sess:
         ...
         for epoch in range(params.No_of_Epochs):
           ...
           for y in range(m_test):
             ...
             mean_accuracy = sum_1/params.NUM_CLASSES
           ...
           np.save('.../path/save/to/test_loss', graph_test)
